...
module.exports = function(app, db) {
  ...
  function putAttachment(name, req, res) {
    ...
    db.putAttachment(name, attachment, rev, body,
  ...
  function getAttachment(name, req, res) {
    ...
    db.get(name, opts, function (err, info) {
      if (err) return utils.sendError(res, err);
      ...
      db.getAttachment(name, attachment, opts, function (err, response) {
        if (err) return utils.sendError(res, err);
  ...
  function deleteAttachment(name, req, res) {
    ...
    db.removeAttachment(name, attachment, rev, function (err, response) {
      if (err) return utils.sendError(res, err);
